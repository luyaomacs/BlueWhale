const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>喜欢听卡布叻唱歌的不成熟代码手艺人<br/>/找工作版<br/>/梦想是一直快乐且自由</div>',
  ...
  SIMPLE_POST_COVER_ENABLE: process.env.NEXT_PUBLIC_SIMPLE_POST_COVER_ENABLE || false, // 是否展示博客封面，是指每一篇文章的封面
